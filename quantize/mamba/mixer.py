...
class MambaModel(MambaPreTrainedModel):
    def __init__(self, config):
        ...
        # self.config.benchmark = dict.fromkeys(["block", "block_reduce", "rmsnorm", "mixer", "in_proj", "conv1d", "x_proj", "mixer_reduce", "dt_proj", "discretization", "out_proj"], [])
    ...
    def forward(
        ...
        print(f"[Rank {rank}] | Completed model")
